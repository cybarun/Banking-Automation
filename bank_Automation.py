...
list_imgs=['images/bank.png','images/images.jpeg','images/img_3.jpeg','images/img_4.jpeg','images/logo_3.png','images/logo_2.png']
def image_animation():
    index=random.randint(0,4)
    img=Image.open(list_imgs[index]).resize((250,90))
    imgtk=ImageTk.PhotoImage(img,master=root) 
    logo_lbl=Label(root,image=imgtk)
    logo_lbl.place(relx=0.84,rely=0)
    logo_lbl.image=imgtk
    logo_lbl.after(500,image_animation)

root=Tk()
root.state('zoomed')
root.configure(bg='#07298E')

title_lbl=Label(root,text="Banking Automation",fg='white',bg='#07298E',font=('Arial',35,'bold','underline'))
title_lbl.pack()

dt_lbl=Label(root,fg='white',font=('Arial',15),bg='#07298E')
dt_lbl.pack(pady=5)
show_dt()

img=Image.open("images/bank.png").resize((250,90))
imgtk=ImageTk.PhotoImage(img,master=root)
...
footer_lbl=Label(root,font=('Arial',20,'bold'),fg='white',bg='#07298E',text="Developed By\nBarun Kumar,📩 barunk622@gmail.com")
...
def main_screen():
    ...
    acntype_lbl=Label(frm,text='ACN Type',font=('Arial',20,'bold'),bg='#f0f6ff')
    ...
    acnno_lbl=Label(frm,text='🔑ACN',font=('Arial',20,'bold'),bg='#f0f6ff')
    ...
    pass_lbl=Label(frm,text='🔒 Pass',font=('Arial',20,'bold'),bg='#f0f6ff')
    pass_lbl.place(relx=.3,rely=.3)

    pass_e=Entry(frm,font=('Arial',20,'bold'),bd=5,show='*')
    pass_e.place(relx=.45,rely=.3)

    captcha_lbl=Label(frm,text='Captcha',font=('Arial',20,'bold'),bg='#f0f6ff')
    ...
    submit_btn=Button(frm,text="Login",command=login,width=17,fg="white",bg="#007bff",activebackground="#0056b3",bd=5,font=('Arial',20,'bold'))
    submit_btn.place(relx=.45,rely=.6)

    fp_btn=Button(frm,text="Forgot Pass",width=17,command=forgot,fg="#007bff",bg="#f0f6ff",bd=2, cursor="hand2",font=('Arial',20,'bold'))
...
def admin_screen():
    ...
    logout_btn=Button(frm,text="logout",bg="#ff4d4d",fg="white", activebackground="#cc0000",bd=5,font=('Arial',20,'bold'),command=logout)
